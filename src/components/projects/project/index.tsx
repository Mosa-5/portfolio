    ...
    return(
        ...
        {projectData.map((project) => { 
            return (
              ...
              >
                <span className="absolute bg-[#d8a013] text-[#25282B] px-2 text-2xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  p-1  opacity-0 group-hover:opacity-100 rounded-xl duration-300 animate-bounce">
                  Press to check out
                </span>
                <ResponsiveImage
                  src={project.image}
