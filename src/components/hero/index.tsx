...
<img src={imageUrl} alt="" className="hidden sm:block max-w-60 md:max-w-xs lg:max-w-sm max-h-md rounded-full border-2 shadow-[4px_4px_0px_0px_black]" />
       </div>
    )
}
