...
<img src={imageUrl} className="sm:hidden max-w-20 max-h-20"/>
            ...
            <button className="flex gap-2 border-2 bg-[#34347C] text-md lg:text-lg hover:bg-[#03055e78] rounded-lg px-6 py-3 md:w-fit text-white shadow-[4px_4px_0_0_black] cursor-pointer font-semibold text-center no-underline select-none transition-all active:shadow-[2px_2px_0_0_black] active:translate-x-[2px] active:translate-y-[2px] items-center justify-center border-black text-background-color">
      Resume
...
<img src={imageUrl} className="hidden w-full sm:block max-w-xs lg:max-w-md slide-in-right hiddenClass"/>
